"""
Training utilities for BrainFLORA.

This module contains training-related utilities including:
- NativeScaler: Mixed precision training scaler
...
class NativeScaler:
    """Native AMP scaler wrapper for mixed precision training."""
...
def train_one_epoch(model, data_loader, optimizer, device, epoch, 
                    ...
                    model_without_ddp=None, img_feature_extractor=None, preprocess=None):
...
def get_1d_sincos_pos_embed(embed_dim, length, cls_token=False):
    ...
    Args:
        ...
        cls_token: Whether to add a cls token position
...
def get_1d_sincos_pos_embed_from_grid(embed_dim, pos):
    """
    Generate sinusoidal positional embeddings from grid positions.
